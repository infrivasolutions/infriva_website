        ...
        <div className="relative z-10 grid min-h-[calc(100vh-100px)] items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div>
            ...
            >
              ...
              <a
                href="#projects"
                className="inline-flex items-center justify-center rounded-2xl border border-white/15 bg-white/10 px-6 py-3.5 text-sm font-extrabold text-white backdrop-blur transition hover:-translate-y-1 hover:bg-white/15 md:text-base"
              >
                View Our Work
              </a>
            </motion.div>
            ...
            >
              {services.map((item) => (
                <span
                  key={item}
                  className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3.5 py-2 text-xs font-semibold text-slate-200 backdrop-blur md:text-sm"
                >
                ...
                <div className="rounded-3xl bg-linear-to-br from-violet-600 via-purple-600 to-fuchsia-600 p-5 shadow-2xl shadow-violet-900/20">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-2 text-4xl font-black">247 Leads</h3>
                  ...
                  <div className="mt-5 grid grid-cols-3 gap-3">
                    <div className="rounded-2xl bg-white/15 p-3">
                      ...
                      <p className="mt-1 text-lg font-black">38</p>
                    </div>

                    <div className="rounded-2xl bg-white/15 p-3">
                      <p className="text-xs text-white/70">Hot</p>
                      <p className="mt-1 text-lg font-black">14</p>
                    </div>

                    <div className="rounded-2xl bg-white/15 p-3">
                      <p className="text-xs text-white/70">Won</p>
                      <p className="mt-1 text-lg font-black">09</p>
                    </div>
                  </div>
                </div>
                  ...
                  {dashboardCards.map((item, index) => (
                    ...
                    >
                      <div>
                        ...
                        <h4 className="mt-1 text-sm font-extrabold text-white md:text-base">
                          {item.value}
                        </h4>
                      </div>
